...
tf.app.flags.DEFINE_string('train_dir', '/media/cangzhu/data/output_2d/train_log', '')
...
def train():
    with tf.Graph().as_default():
        ...
        name_b, coord_diameter_b, frames_b, label_b = nc2.distorted_inputs(data_set, slice=-1)

        # with tf.device('/cpu:0'):
        #     is_training = tf.placeholder('bool', [], name='is_training')

        logits = nc2.inference(frames_b, nc2.PROP_COEF, tf.constant(True, tf.bool))
