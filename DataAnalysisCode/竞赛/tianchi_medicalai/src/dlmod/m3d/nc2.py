...
def inference(frames_batch, train_phase):
    ...
    with tf.variable_scope('local6') as scope:
        ...
        dim2 = 64
        weights = _variable_with_weight_decay('weights', shape=[dim1, dim2], stddev=0.04, wd=0.004)
    ...
    with tf.variable_scope('softmax_linear') as scope:
        dim1, dim2 = dim2, NUM_CLASSES
        weights = _variable_with_weight_decay('weights', [dim1, dim2], stddev=1 / dim1, wd=0.0)
